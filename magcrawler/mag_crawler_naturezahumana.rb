...
def main()
	...
	if url.eql? ""
		...
		url = "http://www.scielo.br/scielo.php?script=sci_issues&pid=0100-6045&lng=en&nrm=iso"
		url = "http://pepsic.bvsalud.org/scielo.php?script=sci_issues&pid=1517-2430&lng=pt&nrm=iso"
	end
