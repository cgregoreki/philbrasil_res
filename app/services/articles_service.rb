...
class ArticlesService
  ...
  def get_N_uncategorized_articles(n)
    return @articles_dao.find_N_uncategorized_articles(n)
  end

  def get_total_number_of_categorized_articles
    return @articles_dao.find_number_of_categorized_articles
  end

  def get_total_number_of_reported_articles
    return @articles_dao.find_number_of_reported_articles
  end

  def get_total_number_of_reported_and_unresolved_articles
    return @articles_dao.find_number_of_reported_and_unresolved_articles
  end
